...
Sofia's bash notes: pwd tells you where you are, ls lists everything in your working directly, cd changes directly (have to specify), cd .. moves you one back. git status -> git add, with a . will add all the changes (aka staging). git command -m "message". git pull to pull, git push to push!
